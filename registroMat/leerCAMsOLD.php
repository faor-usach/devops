...
$SQL = "Select * From cotizaciones Where  Estado = 'E' or Estado = '' Order By tpEnsayo Desc, Estado Desc";
...
if(isset($dato->usrCotizador)){
	if($dato->usrCotizador == 'Todos'){
		...
		if($dato->usrCotizador == 'Baja'){
			...
			$SQL = "Select * From cotizaciones Where usrCotizador = '$dato->usrCotizador' and Estado = 'E' or Estado = '' Order By tpEnsayo Desc, Estado Desc";
		}
	}
}
...
while($rs = mysqli_fetch_array($bd)){
	...
	if($rsc = mysqli_fetch_array($bdc)){
		...
		$bdDe=$link->query("SELECT * FROM solfactura Where RutCli = '".$rsc['RutCli']."'");
