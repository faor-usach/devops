...
<div class="container-fluid">
	<span class="p-3" style="padding-left:20px; font-size:24px;"><strong>Tabla Resumen General</strong></span>
  	<div class="row" style=" border: 1px solid;">
		<?php
			...
			// $bdInd  = $link->query("SELECT * FROM tabindices Where fechaIndice = '2024-12-05'");
		...
		?>
    	<div class="col-sm <?php echo $cProduc; ?>"><span style="font-size:12px;">Producción</span>
			<?php echo number_format($rowInd['iProductividad'], 2, ',', '.');?>
		</div>
    	<div class="col <?php echo $cIndiceMin; ?>"><span style="font-size:12px; ">Mínimo</span>
			<?php echo number_format($rowInd['iMinimo'], 2, ',', '.');?>
		</div>
    	<div class="col <?php echo $cIndiceMet; ?>"><span style="font-size:12px; ">Meta</span>
			<?php echo number_format($rowInd['iMeta'], 2, ',', '.');?>
		</div>
    	<div class="col <?php echo $cIndice; ?>"><span style="font-size:12px; ">Indice</span>
			<?php echo number_format($rowInd['indVtas'] - $TindDesc, 2, ',', '.');?>
		</div>
  	</div>
</div>
...
<table>
	<thead style="background-color: blue; color: #fff; font-weight: bold; margin-top: 5px;">
		<tr>
			<th>
				<h4>Items</h4>
			</th>
