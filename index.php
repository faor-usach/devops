				...
				if(intval($nPerfil)===6){
					...
					if(intval($nPerfil)===4){
						...
						if(intval($nPerfil)===5){
							...
							header("Location: plataformaErp.php?usr=?usr=".$_POST['Login']);
						}
					}
				}
			}
...
<body ng-app="myApp" ng-controller="CtrlAcceso" onLoad="document.acceso.usr.focus();">
		...
		<div id="CajaCpoIzq">
			<form name="acceso" action="index.php" method="post">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
		            ...
		            <tr>
		            	<td>&nbsp;</td>
		                <td><input name="Login" ng-model="usr" type="text" id="usr" value='<?php echo $Login; ?>'></td>
		                <td>&nbsp;</td>
		          	</tr>
		           	<tr>
		            	<td>&nbsp;</td>
		            ...
		            <tr>
		           	...
		           	<tr>
		              	<td>&nbsp;</td>
		                <td class="usrpwd">Contraseña</td>
		                <td>&nbsp;</td>
		            </tr>
		            <tr>
		                <td>&nbsp;</td>
		                <td><input name="pwd" ng-model="pwd" type="password" id="pwd"></td>
		                <td>&nbsp;</td>
		        	</tr>
		            <tr>
		                <td>&nbsp;</td>
		            ...
		            <tr>
		                <td>&nbsp;</td>
		                <td>
							<!-- <button type="button" ng-click="validarAccesoPlataforma()" class="btn btn-primary">Entrar</button> -->
							<input type="submit" class="btn btn-primary" name="acceso" value="Enviar">
						</td>
		                <td>&nbsp;</td>
		         	</tr>
		            <tr>
		            ...
		            <tr>
		                <td>&nbsp;</td>
		                <td class="alertaazul">&iquest;Olvido Contraseña?</td>
		                <td>&nbsp;</td>
		          	</tr>
		            <tr>
		                <td>&nbsp;</td>
