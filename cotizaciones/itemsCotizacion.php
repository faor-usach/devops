...
?>
			...
			<div id="BarraOpciones">
				<div id="ImagenBarraLeft">
					<a href="../plataformaErp.php" title="Menú Principal"><img src="../gastos/imagenes/Menu.png" width="32" height="32"></a><br>
					Principal
				</div>
				<div id="ImagenBarraLeft">
				...
				<div id="ImagenBarraLeft">
					...
					<a href="#" title="Editar Datos Cotización" onClick="registraEncuesta($('#CAM').val(), $('#Rev').val(), $('#Cta').val(), 'Actualiza')"><img src="../imagenes/editarCotizacion.png"></a><br>
					Editar
				</div>
				<?php
					if($CAM){?>
						<div id="ImagenBarraLeft" title="Descargar Cotización">
							<input name="CAM" id="CAM" type="hidden" value="<?php echo $CAM;?>">
							<input name="Rev" id="Rev" type="hidden" value="<?php echo $Rev;?>">
							<input name="Cta" id="Cta" type="hidden" value="<?php echo $Cta;?>">
							<a href="formularios/iCAM.php?CAM=<?php echo $CAM;?>&Rev=<?php echo $Rev;?>&Cta=<?php echo $Cta;?>" title="Descargar Cotización"><img src="../imagenes/pdf_download.png"></a><br>
							Descargar
						</div>
						<div id="ImagenBarraLeft" title="Enviar Cotización...">
							...
							?>
							<a href="formularios/subirEnviarPdf.php?CAM=<?php echo $CAM;?>&Rev=<?php echo $Rev;?>&Cta=<?php echo $Cta;?>" title="Enviar Cotizaci�n"><img src="../imagenes/<?php echo $imgCorreo; ?>"></a><br>
							Enviar
						</div>
						<?php 
					}
				...
				<?php
					if($Moneda == 'P'){?>
						<div id="ImagenBarraLeft">
							...
							<input name="Rev" id="Rev" type="hidden" value="<?php echo $Rev;?>">
							<input name="Cta" id="Cta" type="hidden" value="<?php echo $Cta;?>">
							<a href="#" title="Cotización en U.F." onClick="cambiarMoneda($('#CAM').val(), $('#Rev').val(), $('#Cta').val(), 'UF')"><img src="../imagenes/uf.png"></a><br>
							En U.F.
						</div>
						<?php
					}else{?>
						<div id="ImagenBarraLeft">
							...
							<input name="Rev" id="Rev" type="hidden" value="<?php echo $Rev;?>">
							<input name="Cta" id="Cta" type="hidden" value="<?php echo $Cta;?>">
							<a href="#" title="Cotización en Pesos" onClick="cambiarMoneda($('#CAM').val(), $('#Rev').val(), $('#Cta').val(), 'Pesos')"><img src="../imagenes/pesos.png"></a><br>
							En Pesos
						</div>
						<?php
					}
				...
				<?php if($OFE == 'on'){ ?>
					<div id="ImagenBarraLeft">
						<a href="ofe/index.php?OFE=<?php echo $CAM; ?>&accion=OFE" title="Oferta Económica"><img src="../imagenes/seguimiento.png"></a><br>
						OFE
					</div>
				<?php } ?>
			</div>
...
/*										
										if($row['enviadoCorreo'] == ''){ // Sin Enviar
											echo '<img src="../imagenes/noEnviado.png" 			width="32" height="32" title="Cotizaci�n NO Enviada">';
										}
										if($row['enviadoCorreo'] == 'on'){ // Enviada
											echo '<img src="../imagenes/siEnviado.png" 	width="32" height="32" title="Cotizaci�n Enviada"><br>';
											echo $fechaEnvio;
										}
*/										
										?>
...
/*										
										if($row['Estado'] == 'A'){ // Aceptada
											echo '<img src="../imagenes/printing.png" 			 width="32" height="32" title="Cotizaci�n Aceptada"><br>';
