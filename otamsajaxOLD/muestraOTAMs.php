						...
						<div class="card" style="margin: 10px;">
							...
							<div class="card-footer">
								...
								*/
								...
								<?php
									if($tr == "bVerde" or $tr == "bAmarilla"){
										echo '<a class="btn btn-info" role="button" href="formularios/iRAM.php?accion=Imprimir&RAM='.$rowfRAM['RAM'].'&CAM='.$rowfRAM['CAM'].'"	>Imprimir	</a>';
									}
								?>
								<?php
									if($tr == "bVerde" or $tr == "bAmarilla"){
								...
								<?php
									if($tr == "bVerde" or $tr == "bAmarilla"){
										echo '<a class="btn btn-info" role="button" href="idMuestras.php?accion=Ver&RAM='.$rowfRAM['RAM'].'&CAM='.$rowfRAM['CAM'].'"	>Muestras	</a>';
									}
