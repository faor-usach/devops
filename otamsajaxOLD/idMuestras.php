		...
		<div class="container-fluid">
	    	<div class="collapse navbar-collapse" id="navbarResponsive">
	      		<ul class="navbar-nav ml-auto">
	        		...
	        		<li class="nav-item">
	          			<a class="nav-link far fa-file-alt" href="../procesos/plataformaCotizaciones.php"> Proceso</a>
	        		</li>
	        		<li class="nav-item">
	          			<a class="nav-link fas fa-print" href="formularios/iRAM.php?accion=Imprimir&RAM=<?php echo $RAM; ?>" title="Imprimir RAM"> RAM</a>
	        		</li>
	        		<li class="nav-item">
	          			<a class="nav-link far fa-file-alt" href="pOtams.php?RAM=<?php echo $RAM; ?>"> Volver</a>
	        		</li>
	        		<li class="nav-item">
