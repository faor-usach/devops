	...
	<div>
		<table border="0" cellspacing="0" cellpadding="0" id="CajaTilulo">
			<tr>
				...
				<td  width="05%"  				align="center"><strong>Revisi�n			</strong></td>
				<td  width="12%"  				align="center"><strong>Fecha<br>Aprobaci�n	</strong></td>
		...
		<table border="0" cellspacing="0" cellpadding="0" id="CajaListado">
			<?php
				...
				$bdDoc=mysql_query("SELECT * FROM documentacion $filtroSQL Order By nDocGes"); // N� de Documento de Gesti�n
				if($rowDoc=mysql_fetch_array($bdDoc)){
					do{
						$bdAcc=mysql_query("SELECT * FROM accesodoc Where nDocGes = '".$rowDoc['nDocGes']."' and usr = '".$_SESSION['usr']."'"); // N� de Documento de Gesti�n
