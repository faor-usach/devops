	...
	<div id="BarraOpciones">
		...
		<table width="50%" border="0" cellspacing="0" cellpadding="0" id="tablaDatosAjax" style="margin-top:15px; " align="center">
			...
			<?php
				$link=Conectarse();
				$filtroSQL = "Where nPerfil != 'WM'";
				$bdUs=mysql_query("SELECT * FROM usuarios $filtroSQL Order By nPerfil"); // N� de Documento de Gesti�n
				if($rowUs=mysql_fetch_array($bdUs)){
					do{
						$muestra = 'Si';
						$bdPr=mysql_query("SELECT * FROM perfiles Where IdPerfil = '".$rowUs['nPerfil']."'"); // N� de Documento de Gesti�n
