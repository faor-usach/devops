	...
	DO{
		...
		if ($rowP=mysql_fetch_array($bdP)){
			...
			//if($ServicioIntExt=="I"){
				...
				$pdf->SetXY(179,$nLn);
				$pdf->SetFont('Arial','',5);
				$LinTxt = 'Implementaci�n de ensayos de corrosi�n Implementaci�n de ensayos de corrosi�n Imlementaci�n de ensayos de corroci�n';
...
*/
	...
	$pdf->SetXY(200,186);
	$pdf->Cell(70,5,"V� B� SubDirectora de Proyectos",0,0,"C");
	$pdf->SetXY(200,190);
