...
<body onLoad="inicioformulario()">
	...
	<div id="Cuerpo">
		...
		<div id="CajaCpo">
			<div id="CuerpoTitulo">
				Mantenci�n Proveedores <!-- <img src="imagenes/room_32.png" width="28" height="28"> -->
			...
			<div id="BarraOpciones">
				...
				<div id="ImagenBarraLeft" title="Calculo de Sueldos">
					<a href="CalculoSueldos.php" title="C�lculo de Sueldos">
			...
			<?php
				...
				if($tNetos > 0){
					...
					echo '			<td width="10%">&nbsp;</td>';
					echo '			<td width=" 7%">&nbsp;</td>';
					echo '			<td width="15%">Total P�gina</td>';
