					   ...
					   <div class="col-sm-2">
							...
							if($CodInforme) {
								if($CodigoVerificacion) {
									...
									echo "<iframe scrolling='no' src='../codigoqr/phpqrcode/gQR.php?CodInforme=$CodInforme&data=$dirinfo' width='100%' height='200px' frameborder='0' marginheight='0' marginwidth='0'></iframe>";
