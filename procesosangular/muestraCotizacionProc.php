					...
					do{
						...
						echo '	<td width="08%">';
									...
									if($row[Validez] == 0){
										...
										echo number_format($row[Validez], 0, ',', '.').' d�as';
										$fechaxVencer 	= strtotime ( '+'.$row[Validez].' day' , strtotime ( $row[fechaCotizacion] ) );
										$fechaxVencer 	= date ( 'Y-m-d' , $fechaxVencer );
						...
						echo '	<td width="06%" align="center"><a href="plataformaEncuesta.php?nEnc='.$row[CAM].'&accion=Actualizar"		><img src="../gastos/imagenes/corel_draw_128.png" 	width="40" height="40" title="Editar Cotizaci�n">		</a></td>';
						echo '	<td width="06%" align="center"><a href="plataformaEncuesta.php?nEnc='.$row[CAM].'&accion=Borrar"			><img src="../gastos/imagenes/del_128.png"   		width="40" height="40" title="Borrar Cotizaci�n">		</a></td>';
						echo '</tr>';
