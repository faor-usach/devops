    ...
    app.controller('CtrlCotizaciones', function($scope, $http, $interval) {
        ...
        $scope.grabarCotizacion = function(){
            //$scope.buscaCliente();
            fechaCotizacion = new Date($scope.fechaCotizacion)
            dd = $scope.fechaCotizacion.getDate();
            mm = $scope.fechaCotizacion.getMonth() + 1;
            aa = $scope.fechaCotizacion.getFullYear();
            fecha = $scope.fechaCotizacion.toLocaleDateString();
            // alert('Fecha '+dd+' '+mm+' '+aa);
