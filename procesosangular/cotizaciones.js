...
*/
            ...
            ddEstimada = fechaEstimadaTermino.getDate();
            mmEstimada = fechaEstimadaTermino.getMonth() + 1;
            aaEstimada = fechaEstimadaTermino.getFullYear();

            alert(ddEstimada+'-'+mmEstimada+'-'+aaEstimada);

            $http.post('grabarSeguimientoPAM.php', {
                                                    CAM                 : CAM, 
                                                    RAM                 : RAM,
                                                    Fan                 : Fan,
                                                    ddEstimada          : ddEstimada,
                                                    mmEstimada          : mmEstimada,
                                                    aaEstimada          : aaEstimada,
        ...
        $scope.guardaCAMPAM = function(CAM, RAM, RAMdis, usrCotizador, usrResponzable, fechaEstimadaTermino, fechaAceptacion, nOC, oCompra, oMail, oCtaCte, correoInicioPAM, tpEnsayo, NewcontactoRecordatorio, Observacion, Estado, dHabiles, Rev){
            ...
            ddEstimada = $scope.fechaEstimadaTermino.getDate();
            mmEstimada = $scope.fechaEstimadaTermino.getMonth() + 1;
            aaEstimada = $scope.fechaEstimadaTermino.getFullYear();

            ddAceptacion = $scope.fechaAceptacion.getDate();
            mmAceptacion = $scope.fechaAceptacion.getMonth() + 1;
            aaAceptacion = $scope.fechaAceptacion.getFullYear();

            // alert(NewcontactoRecordatorio+' '+Observacion+' '+Estado+' '+dHabiles);
            $http.post('grabarSeguimientoCAMPAM.php', { 
                                                    ...
                                                    ddAceptacion            : ddAceptacion,
                                                    mmAceptacion            : mmAceptacion,
                                                    aaAceptacion            : aaAceptacion,
