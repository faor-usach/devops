				...
				if ($row=mysqli_fetch_array($bdEnc)){
					do{
						...
						echo '	<td width="10%">';
									...
									echo '</strong>';
						echo ' 	</td>';
						echo '	<td width="10%" align="center"><a href="modCotizacion.php?CAM='.$CAM.'&Cta='.$Cta.'&nServicio='.$row['nServicio'].'&nLin=0&accion=AgregarServ"		><img src="../imagenes/carroCompras2.png"   		width="50" height="50" title="Agregar a Cotizaci�n">		</a></td>';
						echo '</tr>';
