		...
		function informesActividades($usrRes, $tpAccion){
				...
				while($row=mysqli_fetch_array($bdEnc)){
						...
						if($tr != "bRoja") {
							...
							echo ' 	</td>';
							echo '	<td width="06%" align="center"><a href="../procesosangular/modCotizacion.php?CAM=0&Rev=0&Cta=0&accion=Crear"	><img src="../imagenes/other_48.png" 		width="40" height="40" title="ir a Proceso">	</a></td>';
							echo '	<td width="06%" align="center"><a href="rPreCAM.php?idPreCAM='.$row['idPreCAM'].'&accion=Actualizar"><img src="../gastos/imagenes/corel_draw_128.png" 	width="40" height="40" title="Editar PreCAM">	</a></td>';
							echo '	<td width="06%" align="center"><a href="rPreCAM.php?idPreCAM='.$row['idPreCAM'].'&accion=Borrar"	><img src="../gastos/imagenes/del_128.png"   		width="40" height="40" title="Borrar PreCAM">	</a></td>';
							echo '</tr>';
						}
				} 
				$link->close();
