<?php 	
	...
	$link=Conectarse();
	$bdCot=$link->query("SELECT * FROM Visitas Where idVisita = '".$idVisita."'");
			  	...
			  	<td colspan="3" class="lineaDerBot">
					...
					<table cellpadding="0" cellspacing="0" class="tablaRegEquipo" width="100%">
						...
						<tr style="background-color:#CCCCCC;" align="center">
							...
							<td width="12%" class="lineaDerBot" style="font-size:18px;">Acci贸n<br>Realizada<br>(Si/No)	</td>
							<td width="22%" class="lineaDerBot" style="font-size:18px;">Fecha<br>Acci贸n 				</td>
							<td width="12%" class="lineaDerBot" style="font-size:18px;">Acci贸n<br>Registrada 			</td>
