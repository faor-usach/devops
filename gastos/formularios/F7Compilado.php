...
*/
	...
	$pdf->Output('../../Data/AAA/LE/FINANZAS/2025/GASTOS/'.$NombreFormulario,'F'); //Para Descarga
...
if($Iva=="sIva"){
	$filtroSQL = "Where nInforme = '$nInf' and IdProyecto ='".$_GET['IdProyecto']."' and IdRecurso = 5 and Iva = 0 and Estado != 'I'"; 
}
if($Iva=="cIva"){
	$filtroSQL = "Where nInforme = '$nInf' and IdProyecto ='".$_GET['IdProyecto']."' and IdRecurso = 5 and Iva > 0 and Estado != 'I'"; 
}
...
// $bdGto=$link->query("SELECT * FROM MovGastos ".$filtroSQL." Order By FechaGasto Desc");
$bdGto=$link->query("SELECT * FROM movgastos Where nInforme = '$nInf' ");
if ($rowGto=mysqli_fetch_array($bdGto)){
		$nLn += 5;
		$pdf->SetXY(35,$nLn);
...
*/
	...
	$pdf->Output('../../Data/AAA/LE/FINANZAS/2025/GASTOS/'.$NombreFormulario,'F'); //Para Descarga
	$pdf->Output($NombreFormulario,'D'); //Para Descarga
	// copy($NombreFormulario,'../../Data/AAA/LE/FINANZAS/2025/GASTOS/');
