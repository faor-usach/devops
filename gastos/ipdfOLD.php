						...
						<!-- <tr class="table-secondary text-dark" ng-repeat="x in dataSolicitudes">
							...
							<td>
								<?php
				 					...
				 					// $vDir = '../Data/AAA/Archivador-'.$Agno.'/Finanzas/Gastos/Reembolsos/';;
				 					$vDir = '../Data/AAA/LE/FINANZAS/'.$Agno.'/GASTOS/';;
				 					if($ff[0] == 'F7'){ 
				 						// $vDir = '../Data/AAA/Archivador-'.$Agno.'/Finanzas/Gastos/PagoFacturas/';;
				 						$vDir = '..//AAA/LE/FINANZAS/'.$Agno.'/GASTOS/';;
				 					}
				 					$vTmp = 'tmp/'.$doc;
				 					$vDoc = $vDir.$doc;
				 					if(file_exists($vDoc)){
