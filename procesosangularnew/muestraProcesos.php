		...
		<tbody>
			<tr ng-repeat="Pam in CotizacionesPAM | filter: filtroClientes" 
				...
				<td>
					...
					<a style="margin-top: 5px;" class="btn btn-light" role="button" href="formularios/iCAM.php?CAM={{Pam.CAM}}&Rev={{Pam.Rev}}&Cta=0&accion=Reimprime" title="Imprimir Cotización"><i class="far fa-file-pdf"></i></a>
