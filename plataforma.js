    ...
    app.controller('personCtrl', function($scope, $http) {
        ...
        $scope.actualizaCotvsInformes = function(){
            $http.post('dataPlataforma.php',{
                accion      :  "actualizaCotvsInformes"
            })

            .then(function (response) {
                // alert('Se actualizó informes vs informes...');
            }, function(error) {
